                        ...
                        <div class="box">
                                ...
                                <div class="div1">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class=" number">
                                            <div class="num1">
                                                <?php
                                                $sql1 = "SELECT *, SUM(price*quantity) as total FROM `cart` WHERE ymd = $day0 AND `status` = 'complete' AND rid = $rid ";
                                                $result1 = mysqli_query($con, $sql1);
                                                if (mysqli_num_rows($result1) > 0) {
                                                    $row1 = mysqli_fetch_assoc($result1);
                                                ?>
                            ...
                            <div class="statics_box">
                                <div class="header">
                                    ...
                                    <div class="dates">
                                        <div class="year"><?php echo date("D M Y") ?> <i class="fa-regular fa-calendar"></i></div>
