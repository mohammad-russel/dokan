...
$sql = "INSERT INTO cart(rid,pid,price,quantity,discount,`time`,`status`,sr,deller,`year`,`month`,`day`,`ymd`) VALUES ($rid,$pid,$pp,$quantity,$discount,'$time','$status',$sid ,$deller,$year,$month,$day,$ymd)";
